    ...
    <div class='col-md-12'>
        <form class="form-horizontal form-material" action="<?php echo e(url(route('buku.print'))); ?>" method="post"
            ...
            <div class="form-group <?php echo e($errors->has('nama') ? 'has-error' : ''); ?>">
                <label for="judul" class="control-label"><?php echo e('Judul Buku'); ?></label>

                <div class="col-md-12">
                    <input placeholder="judul"
                        class="form-control form-control-line <?php $__errorArgs = ['judul'];
...
unset($__errorArgs, $__bag); ?>" name="judul"
                        type="text" id="judul" value="<?php echo e(isset($anggotum->judul) ? $anggotum->judul : old('judul')); ?>"
                        required>
            ...
            <div class="form-group">
                ...
                <div class="col-md-12">
                    <select class="form-control form-control-line" name='field' required>
                        <?php $__currentLoopData = ['id','judul','penulis','penerbit','tahun','kota','exemplar','ditambahkan']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <table width="100%" border="1" style='margin-bottom: 250px;'>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo e($buku->exemplar); ?></td>
...
<?php /**PATH D:\bikinaplikasi\project\35roza\perpustakaan\resources\views/layouts/buku/laporan/index.blade.php ENDPATH**/ ?>