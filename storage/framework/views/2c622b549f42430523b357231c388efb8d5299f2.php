                    ...
                    <h1 class="page-head-line">
                        ...
                        <?php if($peminjaman->detail_peminjaman->count() && in_array($peminjaman->status, ['Berlangsung', 'Perpanjangan'])): ?>
                            ...
                            <a class='btn btn-success text-white'
                               onclick='var waktu_perpanjangan = window.prompt("Masukkan jumlah perpanjangan, default <?php echo e(env("APP_WAKTU_PERPANJANGAN")); ?> hari?", <?php echo e(env("APP_WAKTU_PERPANJANGAN")); ?>); setTimeout(() => {}, 1000); if (waktu_perpanjangan != null) location.href = "<?php echo e(route("peminjaman.perpanjangan", $peminjaman->id)); ?>?waktu_perpanjangan=" + waktu_perpanjangan'>Perpanjangan</a>
                        <?php else: ?>
                            <?php if(in_array($peminjaman->status, ['Berlangsung', 'Perpanjangan'])): ?>
...
<?php echo $__env->make('layouts.app3', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\bikinaplikasi\project\35roza\perpustakaan\resources\views/peminjaman/show.blade.php ENDPATH**/ ?>