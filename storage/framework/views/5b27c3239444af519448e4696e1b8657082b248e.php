<div class="form-group <?php echo e($errors->has('anggota_id') ? 'has-error' : ''); ?>">
    ...
    <div class="col-md-12">
        ...
        <input list="anggota_id" class="form-control form-control-line" required name="anggota_id" value="<?php echo e(request('anggota_id')); ?>">
        ...
        <datalist id="anggota_id" >
            ...
            <option value="<?php echo e($anggota->id); ?>" <?php echo e((isset($peminjaman->anggota_id) && $peminjaman->anggota_id == $anggota->id) || old('anggota_id') == $anggota->id || request('anggota_id') == $anggota->id ? 'selected' : ''); ?>><?php echo e("$anggota->nama (no induk: $anggota->no_induk)"); ?></option>
...
<div class="form-group <?php echo e($errors->has('status') ? 'has-error' : ''); ?>">
    ...
    <div class="col-md-12">
        ...
        <select name="status" class="form-control form-control-line" id="status" required>
            <?php $__currentLoopData = ['Berlangsung', 'Selesai', 'Perpanjangan']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH D:\bikinaplikasi\project\35roza\perpustakaan\resources\views/peminjaman/form.blade.php ENDPATH**/ ?>