...
<head>
    ...
    <!-- Fontfaces CSS-->
    <link href="<?php echo e(url('')); ?>/css/font-face.css" rel="stylesheet" media="all">
    <link href="<?php echo e(url('')); ?>/vendor/font-awesome-4.7/css/font-awesome.min.css" rel="stylesheet" media="all">
    <link href="<?php echo e(url('')); ?>/vendor/font-awesome-5/css/fontawesome-all.min.css" rel="stylesheet" media="all">
    <link href="<?php echo e(url('')); ?>/vendor/mdi-font/css/material-design-iconic-font.min.css" rel="stylesheet" media="all">

    <!-- Bootstrap CSS-->
    <link href="<?php echo e(url('')); ?>/vendor/bootstrap-4.1/bootstrap.min.css" rel="stylesheet" media="all">

    <!-- Vendor CSS-->
    <link href="<?php echo e(url('')); ?>/vendor/animsition/animsition.min.css" rel="stylesheet" media="all">
    <link href="<?php echo e(url('')); ?>/vendor/bootstrap-progressbar/bootstrap-progressbar-3.3.4.min.css" rel="stylesheet"
          media="all">
    <link href="<?php echo e(url('')); ?>/vendor/wow/animate.css" rel="stylesheet" media="all">
    <link href="<?php echo e(url('')); ?>/vendor/css-hamburgers/hamburgers.min.css" rel="stylesheet" media="all">
    <link href="<?php echo e(url('')); ?>/vendor/slick/slick.css" rel="stylesheet" media="all">
    <link href="<?php echo e(url('')); ?>/vendor/select2/select2.min.css" rel="stylesheet" media="all">
    <link href="<?php echo e(url('')); ?>/vendor/perfect-scrollbar/perfect-scrollbar.css" rel="stylesheet" media="all">

    <!-- Main CSS-->
    <link href="<?php echo e(url('')); ?>/css/theme.css" rel="stylesheet" media="all">
...
<div class="page-wrapper">
    ...
    <aside class="menu-sidebar d-none d-lg-block">
        <div class="logo">
            <h2 class="text-center">
                <a href="#">
                    <?php echo e(strtoupper(auth()->user()->level)); ?>
                ...
                <ul class="list-unstyled navbar__list">
                    ...
                    <li class="has-sub">
                        ...
                        <ul class="list-unstyled navbar__sub-list js-sub-list" style="display: block;">
                            ...
                            <?php if(in_array(auth()->user()->level, ['Admin', 'Petugas'])): ?>
                                <li class="sidebar-item">
                                    <a href="<?php echo e(route('buku-tamu.index')); ?>"
                                       aria-expanded="false" class="sidebar-link waves-effect waves-dark sidebar-link">
                    ...
                    <li class="has-sub">
                        ...
                        <ul class="list-unstyled navbar__sub-list js-sub-list" style="display: block;">
                            ...
                            <li class="sidebar-item <?php if(Route::current()->action['as'] == 'buku-tamu.laporan.index'): ?> selected <?php endif; ?>">
                                <a href="<?php echo e(route('buku-tamu.laporan.index')); ?>" class="sidebar-link"><i
                                        class="fa fa-angle-right"></i>
    ...
    <div class="page-container">
            ...
            <div class="section__content section__content--p30">
                <div class="container-fluid">
                    <div class="header-wrap">
                        <H3 style="margin-bottom: 0px; display: inline-block; color: #333; margin-top: 10px;"><?php echo e(env('APP_NAME')); ?>
                        ...
                        <div class="header-button">
                            <div class="noti-wrap">
                                <div class="noti__item js-item-menu">
                                    ...
                                    <span class="quantity"><?php echo e($notifications->count()); ?></span>
                                    <div class="notifi-dropdown js-dropdown">
                                        ...
                                        <?php $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <a href="<?php echo e(route('peminjaman.index')); ?>?anggota_id=<?php echo e($item->anggota->id); ?>" style="display: block;">
                                                <div class="notifi__item">
                                                    <div class="bg-c2 img-cir img-40">
                                                        <i class="zmdi zmdi-account-box"></i>
                                                    </div>
                                                    <div class="content">
                                                        <p><?php echo e($item->anggota->nama); ?></p>
                                                        <span class="date"><?php echo e($item->tanggal); ?></span>
                                                    </div>
                                                </div>
                                            </a>
                                        ...
                                        <div class="notifi__footer">
                                            <a href="<?php echo e(route('peminjaman.index')); ?>">Semua Notifikasi</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="account-wrap">
                                <div class="account-item clearfix js-item-menu">
                                    <div class="image">
                                        <img src="<?php echo e(url('avatar/png/002-girl.png')); ?>"
                                    ...
                                    <div class="account-dropdown js-dropdown">
                                        ...
                                        <div class="account-dropdown__body">
                                            <div class="account-dropdown__item">
                                                <a href="<?php echo e(url(route('user.profile'))); ?>">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="copyright">
                    <p>Copyright © 2018 <?php echo e(env('APP_NAME')); ?>. All rights reserved.</p>
                </div>
            </div>
        </div>
    </div>
...
<!-- Jquery JS-->
<script src="<?php echo e(url('')); ?>/vendor/jquery-3.2.1.min.js"></script>
<!-- Bootstrap JS-->
<script src="<?php echo e(url('')); ?>/vendor/bootstrap-4.1/popper.min.js"></script>
<script src="<?php echo e(url('')); ?>/vendor/bootstrap-4.1/bootstrap.min.js"></script>
<!-- Vendor JS       -->
<script src="<?php echo e(url('')); ?>/vendor/slick/slick.min.js">
</script>
<script src="<?php echo e(url('')); ?>/vendor/wow/wow.min.js"></script>
<script src="<?php echo e(url('')); ?>/vendor/animsition/animsition.min.js"></script>
<script src="<?php echo e(url('')); ?>/vendor/bootstrap-progressbar/bootstrap-progressbar.min.js">
</script>
<script src="<?php echo e(url('')); ?>/vendor/counter-up/jquery.waypoints.min.js"></script>
<script src="<?php echo e(url('')); ?>/vendor/counter-up/jquery.counterup.min.js">
</script>
<script src="<?php echo e(url('')); ?>/vendor/circle-progress/circle-progress.min.js"></script>
<script src="<?php echo e(url('')); ?>/vendor/perfect-scrollbar/perfect-scrollbar.js"></script>
<script src="<?php echo e(url('')); ?>/vendor/chartjs/Chart.bundle.min.js"></script>
<script src="<?php echo e(url('')); ?>/vendor/select2/select2.min.js">
</script>
            ...
            buttons: tampilkan_buttons === false ? (button_manual === false ? [] : button_manual) :
                [{
                        ...
                        <?php elseif(!in_array(Route::current()->action['as'], ['pembayaran_santri_detail.index', 'pembayaran_santri.index'])): ?>
                    {
                        ...
                        <?php if(in_array(Route::current()->action['as'], ['pembayaran_santri.index']) && auth()->user()->level == 'superadmin'): ?>
                    {
                        text: 'Tambah',
                        className: "btn btn-primary btn-sm",
                        action: function (e, dt, node, config) {
...
<!-- end document-->
<?php /**PATH D:\bikinaplikasi\project\35roza\perpustakaan\resources\views/layouts/app3.blade.php ENDPATH**/ ?>